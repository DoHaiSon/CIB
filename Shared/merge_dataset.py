...
# os.chdir(r"datasets\our_kdd_99\mirai")
...
# # #export to csv
# combined_csv.to_csv(r"C:\Users\dohai\Desktop\CIB\datasets\our_kdd_99\data\mirai_1.csv", header=None, index=False)
train = pd.read_csv(r"datasets\our_kdd_99\data\train_W2_droped.csv", header=None)
print(train)
